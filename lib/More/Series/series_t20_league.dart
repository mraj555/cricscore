...
class T20League extends StatefulWidget {
  const T20League({Key? key}) : super(key: key);

  @override
  State<T20League> createState() => _T20LeagueState();
}

class _T20LeagueState extends State<T20League> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: httpServices.getSeries(type: 'league'),
